...
> queryKey는 반드시 "데이터를 유일하게 식별하는 정보"를 포함해야 합니다.
...
>stale = "다시 요청해도 됨" 이라는 표시일 뿐<br/>
자동 refetch가 발생한다는 의미는 아님

---

### 🔹 stale이 실제로 쓰이는 순간

stale 상태일 때 아래 이벤트가 발생하면 refetch가 일어납니다:

- 컴포넌트 mount
- window focus
- 네트워크 reconnect

이 동작은 아래 옵션과 함께 동작합니다:
